...
classes = [
	...
	WM_OT_NewChainJiggle,
        ...
        WM_OT_PhysicsPreviewHelp,
        WM_OT_CreatePhysicsPreview,
        WM_OT_ClearPhysicsPreview,
        WM_OT_BakePhysicsPreview,
