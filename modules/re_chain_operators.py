...
class WM_OT_PhysicsPreviewHelp(Operator):
        bl_label = "Physics Preview Help"
        bl_idname = "re_chain.physics_preview_help"
        bl_description = "Show step-by-step instructions for using the physics preview workflow"

        help_lines = (
                "1. Select the armature that owns the chain bones.",
                "2. Set the active chain collection in the RE Chain tool panel.",
                "3. Enter Pose Mode and select the chain bones you want to simulate.",
                "4. Press Create Physics Preview to generate the helpers.",
                "5. Play the timeline to preview the simulation.",
                "6. Use Bake Physics Preview to write the motion back to the bones.",
        )
